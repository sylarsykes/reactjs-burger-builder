...
import { BurgersModel } from '../Burgers';
import { CustomBurgersModel } from '../CustomBurgers';
import { CustomersModel } from '../Customers';
import { DeliverersModel } from '../Deliverers';
import { DessertsModel } from '../Desserts';
 ...
 */
OrdersModel.build = (properties) => new OrdersModel(properties);